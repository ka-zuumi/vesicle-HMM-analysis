...
#set output "firstfourthousand-average/hmm-model2-hiddenstate-images/hiddenStateMap-frame00000.png"
...
plot f(t) lw 1 lc rgb "black", 2*f(t) lw 2 lc rgb "black", 3*f(t) lw 1 lc rgb "black", 4*f(t) lw 2 lc rgb "black", "tmp" u (theta($2,$3,$4)):(($5)>0?R($2,$3,$4)+piby2:1/0):1 w p lc palette ps 1 pt 7
...
plot f(t) lw 1 lc rgb "black", 2*f(t) lw 2 lc rgb "black", 3*f(t) lw 1 lc rgb "black", 4*f(t) lw 2 lc rgb "black", "tmp" u (theta($2,$3,$4)):(($5)>0?piby2-R($2,$3,$4):1/0):1 w p lc palette ps 1 pt 7
