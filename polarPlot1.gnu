...
plot f(t) lw 1 lc rgb "black", 2*f(t) lw 2 lc rgb "black", 3*f(t) lw 1 lc rgb "black", 4*f(t) lw 2 lc rgb "black", file u (theta($2,$3,$4)):(($5)>0?R($2,$3,$4)+piby2:1/0):1 w p lc palette ps 1 pt 7

set rtics ('0' pi, 'π/4' 3*pi/4, 'π/2' pi/2, '3π/4' pi/4, 'π' 0)
set rtics offset 1,0

plot f(t) lw 1 lc rgb "black", 2*f(t) lw 2 lc rgb "black", 3*f(t) lw 1 lc rgb "black", 4*f(t) lw 2 lc rgb "black", file u (theta($2,$3,$4)):(($5)>0?piby2-R($2,$3,$4):1/0):1 w p lc palette ps 1 pt 7
